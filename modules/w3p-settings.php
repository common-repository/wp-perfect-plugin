...
function w3p_settings() {
    ...
    <div class="wrap wrap--w3p">
        ...
        <h2 class="nav-tab-wrapper">
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=dashboard' ) ); ?>" class="nav-tab <?php echo $tab === 'dashboard' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Dashboard', 'wp-perfect-plugin' ); ?></a>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=settings' ) ); ?>" class="nav-tab <?php echo $tab === 'settings' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'General Settings', 'wp-perfect-plugin' ); ?></a>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=console' ) ); ?>" class="nav-tab <?php echo $tab === 'console' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Search Engine Console', 'wp-perfect-plugin' ); ?></a>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=meta' ) ); ?>" class="nav-tab <?php echo $tab === 'meta' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Meta Report (Pages)', 'wp-perfect-plugin' ); ?></a>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=meta-posts' ) ); ?>" class="nav-tab <?php echo $tab === 'meta-posts' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Meta Report (Posts)', 'wp-perfect-plugin' ); ?></a>

            <?php if ( (int) get_option( 'w3p_enable_link_whisper' ) === 1 ) { ?>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=links' ) ); ?>" class="nav-tab <?php echo $tab === 'links' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Link Whisper', 'wp-perfect-plugin' ); ?></a>
            <?php } ?>
        </h2>
        ...
        <?php if ( $tab === 'dashboard' ) { ?>
            ...
            <hr>
            <h3><?php esc_html_e( 'Shortcodes & Functions', 'wp-perfect-plugin' ); ?></h3>
            <ul>
            ...
            <form method="post" action="">
                ...
                <h3><?php esc_html_e( 'Module Settings', 'wp-perfect-plugin' ); ?></h3>
                ...
                <p>
                    <input type="submit" name="info_update1" class="button button-primary" value="<?php esc_html_e( 'Save Changes', 'wp-perfect-plugin' ); ?>">
                </p>
            </form>
            <?php
        } elseif ( $tab === 'console' ) {
            ...
            <h3 class="nav-tab-wrapper">
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=verification' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'verification' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Verification and Relationships', 'wp-perfect-plugin' ); ?></a>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=local' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'local' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Local', 'wp-perfect-plugin' ); ?></a>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=kg' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'kg' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Knowledge Graph', 'wp-perfect-plugin' ); ?></a>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=opengraph' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'opengraph' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Open Graph', 'wp-perfect-plugin' ); ?></a>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=crawl' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'crawl' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Crawl Optimization', 'wp-perfect-plugin' ); ?></a>

                <?php if ( (int) get_option( 'w3p_enable_sitemap' ) === 1 ) { ?>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=sitemap-cpt' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'sitemap-cpt' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'XML Sitemaps (Post Types)', 'wp-perfect-plugin' ); ?></a>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=sitemap-tax' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'sitemap-tax' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'XML Sitemaps (Taxonomies)', 'wp-perfect-plugin' ); ?></a>
                <?php } ?>
            </h3>
            ...
            if ( $sub_tab === 'verification' ) {
                ...
                <form method="post" action="">
                    ...
                    <h3><?php esc_html_e( 'Search Engine Verification And Link Relationships', 'wp-perfect-plugin' ); ?></h3>
                    ...
                    <p><input type="submit" name="info_update1" class="button button-primary" value="<?php esc_html_e( 'Save Changes', 'wp-perfect-plugin' ); ?>"></p>
                </form>
                <?php
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table">
                        <tbody>
                            <tr>
                                <th scope="row" colspan="2"><h3><?php esc_html_e( 'Knowledge Graph &amp; Schema.org', 'wp-perfect-plugin' ); ?></h3></th>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="w3p_kg_type">
                                        <?php esc_html_e( 'Website Type', 'wp-perfect-plugin' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <p><?php esc_html_e( 'Choose whether the website represents an organization or a person.', 'wp-perfect-plugin' ); ?></p>

                                    <select name="w3p_kg_type" id="w3p_kg_type">
                                        <option value="organization" <?php selected( 'organization', get_option( 'w3p_kg_type' ) ); ?>><?php esc_html_e( 'Organization', 'wp-perfect-plugin' ); ?></option>
                                        <option value="person" <?php selected( 'person', get_option( 'w3p_kg_type' ) ); ?>><?php esc_html_e( 'Person', 'wp-perfect-plugin' ); ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="w3p_kg_name">
                                        <?php esc_html_e( 'Organization/Person Name', 'wp-perfect-plugin' ); ?>
                                    </label>
                                </th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        <input type="submit" name="info_update" class="button button-primary" value="<?php esc_html_e( 'Save Changes', 'wp-perfect-plugin' ); ?>">
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        <input type="submit" name="crawl_update" class="button button-primary" value="<?php esc_html_e( 'Save Changes', 'wp-perfect-plugin' ); ?>">
                                    </p>
                                </td>
                            </tr>
                        </tbody>
